...
| ----------------- | ----------------- |
| Simple Nginx V1  | BuNnYWaJ/kubenginx:1.0.0  |
| Spring Boot Hello World API  | BuNnYWaJ/kube-helloworld:1.0.0  |
| Simple Nginx V2  | BuNnYWaJ/kubenginx:2.0.0  |
| Simple Nginx V3  | BuNnYWaJ/kubenginx:3.0.0  |
| Simple Nginx V4  | BuNnYWaJ/kubenginx:4.0.0  |
| Backend Application  | BuNnYWaJ/kube-helloworld:1.0.0  |
| Frontend Application  | BuNnYWaJ/kube-frontend-nginx:1.0.0  |
